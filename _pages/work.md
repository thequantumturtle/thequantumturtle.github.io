...
<div class="qt-home qt-subpage">
  ...
  <section class="qt-section">
    ...
    <div class="qt-focus-list">
      <article>
        <h3>Publications</h3>
        <p>Peer-reviewed and technical publications across quantum computing, machine learning, and related areas.</p>
      ...
      <article>
        <h3>Writing</h3>
        <p>Notes and public thinking on quantum computing, technical evaluation, and readiness.</p>

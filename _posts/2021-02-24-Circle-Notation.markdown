...
# $$\psi_A =$$ ![Entangled State A](../assets/img/entangled_A.png 'Entangled State A'){: width="300px"}
{: center}

# $$\psi_B =$$ ![Entangled State B](../assets/img/entangled_B.png 'Entangled State B'){: width="300px"}
{: center}
...
<center>
    <table style="background-color:rgba(0, 0, 0, 0); border:0; margin:auto; text-align: center;">
        ...
        <tr style="background-color:rgba(0, 0, 0, 0);">
            <td style="border:0;"><img src="../assets/img/q_state_a.png" alt="State a" title="State a" width="200px"></td>
            <td style="border:0;"><img src="../assets/img/q_state_b1.png" alt="State b" title="State b" width="200px"></td>
            <td style="border:0;"><img src="../assets/img/q_state_b2.png" alt="State c" title="State c" width="200px"></td>
        </tr>
    </table>
</center>
